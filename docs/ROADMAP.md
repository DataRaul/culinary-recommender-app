...
| V1.x / Corpus Scale / 100k Readiness | STEP 3 CURRENT-RUNTIME PORTABLE LAYOUT PASS / STEP 4 FULL PROOF PENDING | PR #291 Step 1 V2 PASS preserved the frozen 84-record oracle and hardened the current 85-record 1k→100k benchmark; PR #294 Step 2 PASS proved current-runtime RecipeSource V2 behavioral parity; PR #295 Step 3 PASS moved the portable build path to the current 85-record runtime while preserving exact historical-84 compatibility; Step 4 now reruns the indexed retrieval proof from the current runtime seed; no D1/public/protected/billing/Barbecue widening |
