...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 DESIGN BUILT / VALIDATION PENDING | Readiness PASS selected D3; six project-authored recipes are frozen for a media-contract pilot with same-origin/provenance/accessibility/performance firewalls. No image asset is published; third-party/protected source media remain excluded; no public runtime, D1, billing, KC or Barbecue mutation is authorized |
