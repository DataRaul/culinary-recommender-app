...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 BROWSER INTEGRATION PASS / CLOSEOUT NEXT | PR #302 final-head run #1053 proves exact six validated project-authored SVGs on plan/search cards, same-origin lazy loading, alt text, fixed 4:3 layout, offline caching and fail-soft missing-image fallback. Step 1 + Step 7A benchmarks also remain green; no ranking/eligibility/nutrition/filter/admission behavior changes; third-party/protected media, D1, billing, KC and Barbecue remain untouched |
