...
| V1.x / Protected Corpus Runtime Usability V1 | P1 IMPLEMENTATION CI PASS / LIVE OWNER CANARY PENDING | Validate public V0 #1088 passed deterministic + mobile/browser acceptance for auth-first keyset/FTS browse-search, exact two-shard detail hydration, provenance and <=8 target D1/request. Terminal P1 still requires post-deploy authenticated live proof at 19,268/19,268 and exactly 3 soft structural exceptions; no public/recommendation widening |
