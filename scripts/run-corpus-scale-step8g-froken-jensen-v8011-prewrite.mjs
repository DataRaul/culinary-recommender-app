...
import {
  ...
  STEP8G_FROKEN_JENSEN_V8011_LAYER_VERSION,
  STEP8G_FROKEN_JENSEN_V8011_MAX_D1_SUBQUERIES,
  STEP8G_FROKEN_JENSEN_V8011_MAX_REQUEST_BYTES,
  STEP8G_FROKEN_JENSEN_V8011_MAX_ROWS_PER_BATCH,
  STEP8G_FROKEN_JENSEN_V8011_PARENT_COUNT,
  STEP8G_FROKEN_JENSEN_V8011_PARENT_VERSION,
  assertV8011PrewriteBoundaries,
  buildV8010ParentFingerprint,
  plannedV8011OperationBudget
} from "./corpus-scale-step8g-froken-jensen-v8011-prewrite-core.mjs";
...
const PREWRITE_PASS_TERMINAL = "STEP_8G_FROKEN_JENSEN_V8011_PREWRITE_PASS_LIVE_PROTECTED_POPULATION_IMPLEMENTATION_EARNED";
...
function parseArgs(argv) {
  const args = {
    ora: null,
    measurement: "data/generated/step8g/froken-jensen-1921-v8010-measurement.json",
    parentPrewrite: "data/generated/step8g/artusi-v8010-prewrite-evidence.json",
    parentLive: "data/generated/step8g/artusi-v8010-live-pass.json",
    output: ".tmp/step8g-froken-jensen-v8011-prewrite"
  };
...
function buildPackets(rows) {
  if (rows.length !== STEP8G_FROKEN_JENSEN_V8011_CHILD_COUNT) throw new Error(`EXPECTED_${STEP8G_FROKEN_JENSEN_V8011_CHILD_COUNT}_GOT_${rows.length}`);
  const seen = new Set();
  return rows.map(row => {
    assertSourceRow(row);
    ...
    const packet = {
      ...
      source: {
        ...
        sourceAuthorDisplay: "Kristine Marie Jensen",
...
function buildPlan(packets) {
  ...
  const plan = buildStep8APopulationPlan({
    corpusVersion: STEP8G_FROKEN_JENSEN_V8011_LAYER_VERSION,
    parentCorpusVersion: STEP8G_FROKEN_JENSEN_V8011_PARENT_VERSION,
    sourceCohorts: [{
      id: SOURCE.cohortId,
      sourceName: `${SOURCE.sourceTitle} (${SOURCE.expectedRecipeCount}-record rights-cleared historical cohort)`,
      sourceVersion: ORA_COMMIT,
      admissionState: "STEP_8G_ORA_FROKEN_JENSEN_1921_MEASUREMENT_EARNED_COHORT_CANDIDATE",
      protectedPopulationAllowed: true,
      publicRuntimeActivationAuthorized: false,
      evidenceRefs: [
        "data/generated/step8g/froken-jensen-1921-v8010-measurement.json",
        "docs/CORPUS_SCALE_STEP8G_FROKEN_JENSEN_1921_RIGHTS_AND_MEASUREMENT.md",
        SOURCE.sourceUrl,
...
if (measurement?.pass !== true || measurement?.terminal !== "STEP_8G_ORA_FROKEN_JENSEN_1921_MEASUREMENT_EARNED_COHORT_CANDIDATE" || Number(measurement?.candidate?.recipeCount) !== STEP8G_FROKEN_JENSEN_V8011_CHILD_COUNT) throw new Error("EARNED_FROKEN_JENSEN_MEASUREMENT_REQUIRED");
...
const parentFingerprint = buildV8010ParentFingerprint({ prewriteEvidence: parentPrewrite, liveEvidence: parentLive, runtimeDescriptor: STEP8G_V8010_RUNTIME_DESCRIPTOR });
...
const requestSizePass = maxWriteRequestBytes <= STEP8G_FROKEN_JENSEN_V8011_MAX_REQUEST_BYTES;
const operationBudgetPass = operationBudget.pass && operationBudget.maxPlannedD1Subqueries <= STEP8G_FROKEN_JENSEN_V8011_MAX_D1_SUBQUERIES;
...
const countPass = STEP8G_FROKEN_JENSEN_V8011_PARENT_COUNT + plan.manifest.recipeCount === STEP8G_FROKEN_JENSEN_V8011_COMPOSED_COUNT;
const batchSizePass = maxRowsPerBatch <= STEP8G_FROKEN_JENSEN_V8011_MAX_ROWS_PER_BATCH;
...
const evidence = {
  schema: "CORPUS_SCALE_STEP8G_FROKEN_JENSEN_V8011_PREWRITE_V1",
  pass,
  ...
  parent: {
    activeCorpusVersion: STEP8G_FROKEN_JENSEN_V8011_PARENT_VERSION,
  ...
  layer: {
    ...
    maxAllowedWriteRequestBytes: STEP8G_FROKEN_JENSEN_V8011_MAX_REQUEST_BYTES,
    requestSizePass,
    operationBudget,
  ...
  composition: {
    activeCorpusVersion: STEP8G_FROKEN_JENSEN_V8011_LAYER_VERSION,
    parentCorpusVersion: STEP8G_FROKEN_JENSEN_V8011_PARENT_VERSION,
    cumulativeRecipeCount: STEP8G_FROKEN_JENSEN_V8011_COMPOSED_COUNT,
    capacity,
    routing: {
      shardCount: STEP8G_SHARD_COUNT,
      mode: "CONTROL_INDEX_EXACT_ROUTE_THEN_BATCH_HYDRATE_BY_SHARD",
      fullCorpusScans: 0,
      maxProtectedD1Subqueries: STEP8G_FROKEN_JENSEN_V8011_MAX_D1_SUBQUERIES,
  ...
  decision: pass ? "EARN_V8011_LIVE_PROTECTED_POPULATION_IMPLEMENTATION_ON_EXISTING_TWO_SHARD_AND_16_QUERY_ENVELOPE" : "STOP_CAPACITY_OR_COST_GATE"
};
assertV8011PrewriteBoundaries(evidence);

const validation = {
  schema: "CORPUS_SCALE_STEP8G_FROKEN_JENSEN_V8011_PREWRITE_VALIDATION_V1",
  date: "2026-09-19",
  pass,
  ...
  manifestSha256: plan.manifest.manifestSha256,
  populationPlanSha256: plan.populationPlanSha256,
  countContract: { parent: STEP8G_FROKEN_JENSEN_V8011_PARENT_COUNT, child: STEP8G_FROKEN_JENSEN_V8011_CHILD_COUNT, composed: STEP8G_FROKEN_JENSEN_V8011_COMPOSED_COUNT },
