...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 ASSET PILOT PASS / BROWSER INTEGRATION NEXT | Six project-authored 960×720 same-origin SVG illustrations pass deterministic file/hash/security/budget validation in run #1045. Public UI activation remains false until bounded integration; third-party/protected source media remain excluded; no D1, billing, KC or Barbecue mutation |
