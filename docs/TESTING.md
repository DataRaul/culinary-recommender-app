...
## Browser smoke
Public CI installs pinned Playwright/Chromium and verifies a 390×844 mobile flow: load → vegetarian/high-protein plan → plan screen → groceries → pantry. Tests run against a local static server and do not call third-party APIs.
