...
B49 uses Food Group 06 report https://www.ars.usda.gov/ARSUserFiles/80400535/Data/SR/SR28/reports/sr28fg06.pdf . NDB `06179`, **Sauce, fish, ready-to-serve**, directly publishes **18 g: 1 tbsp**. B49 admits only canonical `fish_sauce|tbsp` at 18 g/tbsp. It does not authorize teaspoons, cups, generic tablespoon arithmetic, oyster/soy sauce, fish stock, another sauce identity, or any SR28 composition value. The independent B48 MEXT composition evidence remains separately governed.
...
B39 and B48 each bundle one exact composition row from Japan's Ministry of Education, Culture, Sports, Science and Technology (MEXT), **Standard Tables of Food Composition in Japan (Eighth Revised Edition), Supplement 2023**.
...
- B39 reviewed food number: `17016`, **Rice vinegar**
- B39 source page: https://fooddb.mext.go.jp/details/details.pl?ITEM_NO=17_17016_7
- B48 reviewed food number: `17107`, **Nam pla (fish sauce)**
- B48 source page: https://fooddb.mext.go.jp/details/details.pl?ITEM_NO=17_17107_7
...
- Reuse boundary: MEXT states that food-composition data may be freely used and asks secondary users, including applications, to identify the source. These tranches store only the reviewed tracked fields and bounded identity/provenance metadata.
