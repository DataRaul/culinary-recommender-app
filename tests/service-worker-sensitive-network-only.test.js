...
test("service worker never Cache-Storages API/auth/protected runtime traffic", () => {
  assert.match(sw, /const CACHE = "culinary-recommender-v1-1-6-eu-celery-allergen-p0"/);
  assert.match(sw, /"\/api\/"/);
