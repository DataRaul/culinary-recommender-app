...
| V1.x / Corpus Scale / 100k Readiness | STEP 4 PASS / STEP 5 EXISTING CONTROL PLANE RECONCILED / STEP 6 CURRENT-85 SEED VALIDATION PENDING | PR #291 Step 1 V2 PASS; PR #294 Step 2 current-runtime parity PASS; PR #295 Step 3 current-runtime portable layout PASS; PR #296 Step 4 current-runtime 100k indexed retrieval PASS with D1 not earned. Step 5 has no recipe-count-specific compatibility gap and is undergoing fresh full validation; Step 6 now uses current 85 `PUBLIC_RUNTIME_RECIPES` for incremental fixtures while preserving the historical 84 `ALL_RECIPES` golden oracle; no real-source/public/protected/billing/Barbecue/KC widening |
