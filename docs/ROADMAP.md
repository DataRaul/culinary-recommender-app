...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 BROWSER INTEGRATION BUILT / VALIDATION PENDING | Exact six validated project-authored SVGs are wired to plan/search cards with same-origin lazy loading, alt text, fixed 4:3 layout, offline caching and fail-soft missing-image fallback. No ranking/eligibility/nutrition/filter/admission behavior changes; third-party/protected media, D1, billing, KC and Barbecue remain untouched |
