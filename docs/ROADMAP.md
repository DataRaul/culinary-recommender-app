...
| V1.x / Further Product Features | D5 FITNESS P0 ADAPTER DESIGN BUILT / VALIDATION PENDING | post-D3 reassessment selected D5; exact minimum-data one-way contract now limits input to user-selected workout backup schema + goal/days/session-minutes/weekdays. Name, constraints, history, set data and other sensitive/private fields remain excluded; no runtime activation, calorie/TDEE, nutrition/supplement prescription, cloud sync, D1, billing, KC or Barbecue widening |
