...
const CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD = Object.freeze({
...
const JEWISH_MANUAL_1846_ATTRIBUTION_HOLD = Object.freeze({
  collection: "jewish-kitchen",
...
const heldSourceKeys = new Set([
  ...
  oraSourceKey(CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD),
  oraSourceKey(JEWISH_MANUAL_1846_ATTRIBUTION_HOLD)
]);
...
const output = {
  ...
  exclusions: {
    ...
    heldSources: [
      ...
      {
        collection: CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD.collection,
        sourceUrl: CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD.source_url,
        sourceTitle: CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD.source_title,
        sourceAuthorAsInOra: CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD.author,
        sourceYear: CANADIAN_FAMILY_1914_CONTRIBUTOR_PROVENANCE_HOLD.source_year,
        reason: "EXACT_1914_WORK_IDENTIFIES_RECIPES_BY_PROMINENT_CANADIAN_LADIES_AND_CONTRIBUTOR_LIST__ORA_FLATTENS_TO_GRACE_DENISON_AUTHOR"
      },
      {
        collection: JEWISH_MANUAL_1846_ATTRIBUTION_HOLD.collection,
        sourceUrl: JEWISH_MANUAL_1846_ATTRIBUTION_HOLD.source_url,
        sourceTitle: JEWISH_MANUAL_1846_ATTRIBUTION_HOLD.source_title,
        sourceAuthorAsInOra: JEWISH_MANUAL_1846_ATTRIBUTION_HOLD.author,
        sourceYear: JEWISH_MANUAL_1846_ATTRIBUTION_HOLD.source_year,
        reason: "EXACT_1846_WORK_CREDITS_ONLY_A_LADY__JUDITH_MONTEFIORE_ATTRIBUTION_LACKS_DOCUMENTARY_PROOF"
      }
    ],
