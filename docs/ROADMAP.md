...
| V1.x / Corpus Scale / 100k Readiness | STEPS 1–6 CURRENT-STATE RECONCILIATION PASS / DOWNSTREAM LIVE-ARCHITECTURE RECONCILIATION NEXT | PR #291 Step 1 V2 PASS; PR #294 Step 2 current-runtime parity PASS; PR #295 Step 3 current-runtime portable layout PASS; PR #296 Step 4 current-runtime 100k indexed retrieval PASS with D1 not earned; PR #297 Step 5 source-neutral control plane revalidated and Step 6 incremental validation reconciled to the current 85-record seed while preserving the historical 84-record oracle. Existing live Steps 7/8 must be fresh-reconciled rather than recreated; no real-source/public/protected/billing/Barbecue/KC widening |
