...
| V1.x / EU regulatory truth lane | LANE 3 / SCAFFOLDING ACTIVE / ZERO-D1 / NO-BEHAVIOR AUTHORITY | Owner-authorized independent lane. Official EU/EFSA source truth, provenance and schema scaffolding may advance without protected D1 and without touching recommendation authority or Barbecue. Next gate: `EU_REGULATORY_TRUTH_SCAFFOLD_V1_PASS`; any behavior integration remains separately gated |
