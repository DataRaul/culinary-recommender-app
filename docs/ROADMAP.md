...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 COMPLETE / REASSESS REMAINING CAPABILITIES NEXT | PR #302 merged; post-merge validation #1058 and Pages deployment #353 passed. Exact six project-authored images are the frozen P0 baseline; no ranking/eligibility/nutrition/filter/admission behavior changed. Broader media is separately gated; D1, billing, KC and Barbecue remain untouched |
