...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 ASSET PILOT BUILT / VALIDATION PENDING | Six project-authored 960×720 same-origin SVG illustrations are materialized for the exact P0 cohort; deterministic file/hash/security/budget validation is pending. Public UI activation remains false; third-party/protected source media remain excluded; no D1, billing, KC or Barbecue mutation |
