...
import { ORA_VIARD_1806_SOURCE, measureOraViard1806Candidate } from "./corpus-scale-step8g-ora-viard-1806-core.mjs";
...
const EXPECTED_V8012_COUNT = 14846;
...
function parseArgs(argv) {
  const out = { ora: null, forkrecipe: null, unitools: null, cc0: null, rightsDoc: null, output: ".tmp/step8g-viard-1806-measurement" };
...
if (protectedBaseline.length !== EXPECTED_V8012_COUNT) throw new Error(`V8012_BASELINE_${protectedBaseline.length}`);
...
const attributionClassified = rightsDoc.includes("CLASSIFIED_READY_FOR_PRIVATE_CORPUS__VIARD_1806_EXACT_SOURCE_ATTRIBUTION");
const editionSemanticsClassified = rightsDoc.includes("CLASSIFIED_SOURCE_YEAR_AS_BNF_ALIGNED_1806_FIRST_EDITION");
const rightsDocumented = rightsDoc.includes(ORA_VIARD_1806_SOURCE.rightsMarker);

const result = measureOraViard1806Candidate({
  candidateRows,
  baselineRecipes,
  rightsDocumented,
  repositoryReusePass,
