...
| V1.x / Further Product Features | D3 RECIPE IMAGES P0 DESIGN PASS / ASSET PILOT NEXT | PR #300 contract validation is green: six project-authored recipes are frozen for a same-origin media pilot with provenance, accessibility, fallback and performance firewalls. No image asset is published by the design gate; third-party/protected source media remain excluded; no public runtime, D1, billing, KC or Barbecue mutation is authorized |
