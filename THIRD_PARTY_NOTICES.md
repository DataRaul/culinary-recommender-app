...
The B6 household-portion evidence and bounded B9/B10/B11 composition evidence are separate source roles. B10 is further restricted to exact tracked-field completion where existing reviewed composition has no value. Admission of one role does not silently authorize another.
