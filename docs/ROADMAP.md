...
| V1.x / Corpus Scale / 100k Readiness | STEP 4 CURRENT-RUNTIME INDEXED RETRIEVAL PASS / D1 NOT EARNED / STEP 5 VALIDATION NEXT | PR #291 Step 1 V2 PASS preserved the frozen 84-record oracle and hardened the current 85-record seed; PR #294 Step 2 PASS proved current-runtime RecipeSource V2 parity; PR #295 Step 3 PASS validated the current 85-record portable layout; PR #296 Step 4 proof is green through 100k (build 4.400s; max retrieval p95 16.031ms; max rank p95 5.542ms; RSS 272.8MB; heap 78.7MB), so pre-built object indexes remain the baseline and D1 is not earned; no public/protected/billing/Barbecue/KC widening |
