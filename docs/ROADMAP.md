...
| V1.x / Protected Corpus Runtime Usability V1 | P1 PRIVATE BROWSE-SEARCH IMPLEMENTATION BUILT / VALIDATION PENDING | Owner-only v8018 / 19,268 browse-search canary now uses auth-first control-D1 keyset + FTS index, exact two-shard detail hydration, provenance display, <=8 target D1/request and no public/recommendation widening. Deterministic/browser CI is next; terminal P1 still requires post-deploy authenticated live proof at 19,268/19,268 and 3 soft structural exceptions |
