...
| V1.x / Corpus Scale / 100k Readiness | STEP 2 CURRENT-RUNTIME PARITY PASS / STEP 3 VALIDATION PENDING | PR #291 Step 1 V2 PASS preserved the frozen 84-record oracle and hardened the current 85-record 1k→100k benchmark; PR #294 Step 2 PASS proved exact current-runtime RecipeSource V2 plus ranking/planner/ingredient-search parity; Step 3 now reconciles the portable object layout/build command to the current 85-record runtime while preserving the historical oracle; no D1/public/protected/billing/Barbecue widening |
